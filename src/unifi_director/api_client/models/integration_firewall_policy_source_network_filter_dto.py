...
T = TypeVar("T", bound="IntegrationFirewallPolicySourceNetworkFilterDto")


@_attrs_define
class IntegrationFirewallPolicySourceNetworkFilterDto:
    """
    Attributes:
        type_ (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_firewall_policy_source_network_filter_dto = cls(
            type_=type_,
        ...
        integration_firewall_policy_source_network_filter_dto.additional_properties = d
        return integration_firewall_policy_source_network_filter_dto
