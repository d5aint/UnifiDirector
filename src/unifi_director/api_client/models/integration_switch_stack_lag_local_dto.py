...
T = TypeVar("T", bound="IntegrationSwitchStackLagLocalDto")


@_attrs_define
class IntegrationSwitchStackLagLocalDto:
    """
    Attributes:
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_switch_stack_lag_local_dto = cls(
            id=id,
            members=members,
            metadata=metadata,
        )

        integration_switch_stack_lag_local_dto.additional_properties = d
        return integration_switch_stack_lag_local_dto
