...
T = TypeVar("T", bound="PatchFirewallPolicy")


@_attrs_define
class PatchFirewallPolicy:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_policy = cls(
            logging_enabled=logging_enabled,
        )

        patch_firewall_policy.additional_properties = d
        return patch_firewall_policy
