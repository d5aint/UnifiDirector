...
T = TypeVar("T", bound="IntegrationFirewallPolicyDestinationRegionFilterDto")


@_attrs_define
class IntegrationFirewallPolicyDestinationRegionFilterDto:
    """
    Attributes:
        type_ (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_firewall_policy_destination_region_filter_dto = cls(
            type_=type_,
            region_filter=region_filter,
            port_filter=port_filter,
        )

        integration_firewall_policy_destination_region_filter_dto.additional_properties = d
        return integration_firewall_policy_destination_region_filter_dto
