...
class HotspotVoucherDetails:
    ...
    Attributes:
        ...
        authorized_guest_limit (int | Unset): (Optional) limit for how many different guests can use the same voucher to
            authorize network access Example: 1.
        activated_at (datetime.datetime | Unset): (Optional) timestamp when the voucher has been activated
            (authorization time of the first guest)
        expires_at (datetime.datetime | Unset): (Optional) timestamp when the voucher will become expired. All guests
            using the voucher will be unauthorized from network access
        data_usage_limit_m_bytes (int | Unset): (Optional) data usage limit in megabytes Example: 1024.
        rx_rate_limit_kbps (int | Unset): (Optional) download rate limit in kilobits per second Example: 1000.
        tx_rate_limit_kbps (int | Unset): (Optional) upload rate limit in kilobits per second Example: 1000.
    """
    ...
    authorized_guest_limit: int | Unset = UNSET
    activated_at: datetime.datetime | Unset = UNSET
    expires_at: datetime.datetime | Unset = UNSET
    data_usage_limit_m_bytes: int | Unset = UNSET
    rx_rate_limit_kbps: int | Unset = UNSET
    tx_rate_limit_kbps: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_activated_at, Unset):
            ...
            activated_at = datetime.datetime.fromisoformat(_activated_at)
