...
T = TypeVar("T", bound="IntegrationWifiNonEnterpriseRadiusConfigurationDto")


@_attrs_define
class IntegrationWifiNonEnterpriseRadiusConfigurationDto:
    """
    Attributes:
        profile_id (UUID):
        nas_id (WifiRadiusNASIDConfiguration):
        mac_authentication_configuration (IntegrationWifiRadiusMacAuthenticationConfigurationDto):
    """
        ...
        field_dict.update(
            {
                ...
                "nasId": nas_id,
                "macAuthenticationConfiguration": mac_authentication_configuration,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mac_authentication_configuration = IntegrationWifiRadiusMacAuthenticationConfigurationDto.from_dict(
            d.pop("macAuthenticationConfiguration")
        )

        integration_wifi_non_enterprise_radius_configuration_dto = cls(
            profile_id=profile_id,
            nas_id=nas_id,
            mac_authentication_configuration=mac_authentication_configuration,
        )

        integration_wifi_non_enterprise_radius_configuration_dto.additional_properties = d
        return integration_wifi_non_enterprise_radius_configuration_dto
