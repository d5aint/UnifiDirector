...
T = TypeVar("T", bound="WifiBroadcastCreateOrUpdate")


@_attrs_define
class WifiBroadcastCreateOrUpdate:
    """
    Attributes:
        type_ (str):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wifi_broadcast_create_or_update = cls(
            type_=type_,
            name=name,
            enabled=enabled,
        ...
        wifi_broadcast_create_or_update.additional_properties = d
        return wifi_broadcast_create_or_update
