...
class LatestStatisticsForADevice:
    ...
    Attributes:
        ...
        last_heartbeat_at (datetime.datetime | Unset):
        next_heartbeat_at (datetime.datetime | Unset):
        load_average_1_min (float | Unset):
        load_average_5_min (float | Unset):
        load_average_15_min (float | Unset):
        cpu_utilization_pct (float | Unset):
        memory_utilization_pct (float | Unset):
        uplink (LatestStatisticsForADeviceUplinkInterface | Unset):
    """

    interfaces: LatestStatisticsForDeviceInterfaces
    uptime_sec: int | Unset = UNSET
    last_heartbeat_at: datetime.datetime | Unset = UNSET
    next_heartbeat_at: datetime.datetime | Unset = UNSET
    load_average_1_min: float | Unset = UNSET
    load_average_5_min: float | Unset = UNSET
    load_average_15_min: float | Unset = UNSET
    cpu_utilization_pct: float | Unset = UNSET
    memory_utilization_pct: float | Unset = UNSET
    uplink: LatestStatisticsForADeviceUplinkInterface | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        last_heartbeat_at: str | Unset = UNSET
        if not isinstance(self.last_heartbeat_at, Unset):
            last_heartbeat_at = self.last_heartbeat_at.isoformat()

        next_heartbeat_at: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_last_heartbeat_at, Unset):
            ...
            last_heartbeat_at = datetime.datetime.fromisoformat(_last_heartbeat_at)
        ...
        if isinstance(_next_heartbeat_at, Unset):
            ...
            next_heartbeat_at = datetime.datetime.fromisoformat(_next_heartbeat_at)
