...
class HotspotVoucherCreationRequest:
    ...
    Attributes:
        ...
        count (int | Unset): Number of vouchers to generate Default: 1.
        ...
        data_usage_limit_m_bytes (int | Unset): (Optional) data usage limit in megabytes
        rx_rate_limit_kbps (int | Unset): (Optional) download rate limit in kilobits per second
        tx_rate_limit_kbps (int | Unset): (Optional) upload rate limit in kilobits per second
    """
