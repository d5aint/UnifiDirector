...
T = TypeVar("T", bound="IntegrationFirewallPolicyDestinationIpv6IidFilterDto")


@_attrs_define
class IntegrationFirewallPolicyDestinationIpv6IidFilterDto:
    """
    Attributes:
        type_ (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_firewall_policy_destination_ipv_6_iid_filter_dto = cls(
            type_=type_,
            ipv_6_iid_filter=ipv_6_iid_filter,
            port_filter=port_filter,
        )

        integration_firewall_policy_destination_ipv_6_iid_filter_dto.additional_properties = d
        return integration_firewall_policy_destination_ipv_6_iid_filter_dto
