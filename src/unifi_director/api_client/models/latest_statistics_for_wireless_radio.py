...
from ..models.latest_statistics_for_wireless_radio_frequency_g_hz import LatestStatisticsForWirelessRadioFrequencyGHz
...
class LatestStatisticsForWirelessRadio:
    ...
    Attributes:
        ...
        tx_retries_pct (float | Unset):
    """

    frequency_g_hz: LatestStatisticsForWirelessRadioFrequencyGHz
    tx_retries_pct: float | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        frequency_g_hz = LatestStatisticsForWirelessRadioFrequencyGHz(d.pop("frequencyGHz"))
