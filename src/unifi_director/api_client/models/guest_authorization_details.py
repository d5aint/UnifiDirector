...
class GuestAuthorizationDetails:
    ...
    Attributes:
        ...
        usage (GuestAuthorizationUsageDetails | Unset):
    """
    ...
    usage: GuestAuthorizationUsageDetails | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        authorized_at = datetime.datetime.fromisoformat(d.pop("authorizedAt"))
