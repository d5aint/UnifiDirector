...
T = TypeVar("T", bound="FirewallPolicyIPv4AndIPv6ProtocolNumber")


@_attrs_define
class FirewallPolicyIPv4AndIPv6ProtocolNumber:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        firewall_policy_i_pv_4_and_i_pv_6_protocol_number = cls(
            type_=type_,
            protocol_number=protocol_number,
            match_opposite=match_opposite,
        )

        firewall_policy_i_pv_4_and_i_pv_6_protocol_number.additional_properties = d
        return firewall_policy_i_pv_4_and_i_pv_6_protocol_number
