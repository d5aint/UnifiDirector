...
from ..models.integration_wifi_wpa_2_wpa_3_personal_security_configuration_detail_dto_pmf_mode import (
    IntegrationWifiWpa2Wpa3PersonalSecurityConfigurationDetailDtoPmfMode,
)
...
T = TypeVar("T", bound="IntegrationWifiWpa2Wpa3PersonalSecurityConfigurationDetailDto")


@_attrs_define
class IntegrationWifiWpa2Wpa3PersonalSecurityConfigurationDetailDto:
    """
    Attributes:
        type_ (str):
        passphrase (str):
        pmf_mode (IntegrationWifiWpa2Wpa3PersonalSecurityConfigurationDetailDtoPmfMode): Protected Management Frames
    ...
    type_: str
    passphrase: str
    pmf_mode: IntegrationWifiWpa2Wpa3PersonalSecurityConfigurationDetailDtoPmfMode
    sae_configuration: IntegrationWifiSaeConfigurationDto
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pmf_mode = IntegrationWifiWpa2Wpa3PersonalSecurityConfigurationDetailDtoPmfMode(d.pop("pmfMode"))
        ...
        integration_wifi_wpa_2_wpa_3_personal_security_configuration_detail_dto = cls(
            type_=type_,
            passphrase=passphrase,
            pmf_mode=pmf_mode,
        ...
        integration_wifi_wpa_2_wpa_3_personal_security_configuration_detail_dto.additional_properties = d
        return integration_wifi_wpa_2_wpa_3_personal_security_configuration_detail_dto
