...
if TYPE_CHECKING:
    from ..models.firewall_policy_mac_address_filter import FirewallPolicyMACAddressFilter
    from ..models.firewall_policy_port_filter import FirewallPolicyPortFilter


T = TypeVar("T", bound="IntegrationFirewallPolicySourceMacAddressFilterDto")


@_attrs_define
class IntegrationFirewallPolicySourceMacAddressFilterDto:
    """
    Attributes:
        type_ (str):
        mac_address_filter (FirewallPolicyMACAddressFilter):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        mac_address_filter = self.mac_address_filter.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mac_address_filter = FirewallPolicyMACAddressFilter.from_dict(d.pop("macAddressFilter"))
        ...
        integration_firewall_policy_source_mac_address_filter_dto = cls(
            type_=type_,
            mac_address_filter=mac_address_filter,
            port_filter=port_filter,
        )

        integration_firewall_policy_source_mac_address_filter_dto.additional_properties = d
        return integration_firewall_policy_source_mac_address_filter_dto
