...
class GuestAccessAuthorizationResponse:
    ...
    Attributes:
        ...
        revoked_authorization (GuestAuthorizationDetails | Unset):
    """

    action: str
    granted_authorization: GuestAuthorizationDetails
    revoked_authorization: GuestAuthorizationDetails | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        revoked_authorization: dict[str, Any] | Unset = UNSET
