...
T = TypeVar("T", bound="NetworkIPv6Configuration")


@_attrs_define
class NetworkIPv6Configuration:
    """
    Attributes:
        interface_type (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_i_pv_6_configuration = cls(
        ...
        network_i_pv_6_configuration.additional_properties = d
        return network_i_pv_6_configuration
