...
from ..models.integration_standard_wifi_broadcast_detail_dto_broadcasting_frequencies_g_hz_item import (
    IntegrationStandardWifiBroadcastDetailDtoBroadcastingFrequenciesGHzItem,
)
...
T = TypeVar("T", bound="IntegrationStandardWifiBroadcastDetailDto")


@_attrs_define
class IntegrationStandardWifiBroadcastDetailDto:
    """
    Attributes:
        type_ (str):
        id (UUID):
        ...
        broadcasting_frequencies_g_hz (list[IntegrationStandardWifiBroadcastDetailDtoBroadcastingFrequenciesGHzItem]):
            Example: [2.4, 5].
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_standard_wifi_broadcast_detail_dto = cls(
            type_=type_,
            id=id,
            name=name,
            metadata=metadata,
        ...
        integration_standard_wifi_broadcast_detail_dto.additional_properties = d
        return integration_standard_wifi_broadcast_detail_dto
