...
T = TypeVar("T", bound="IntegrationFirewallPolicyPortReferenceFilterDto")


@_attrs_define
class IntegrationFirewallPolicyPortReferenceFilterDto:
    """
    Attributes:
        type_ (str):
        match_opposite (bool): Match on all ports except the specified ones.
        traffic_matching_list_id (UUID): ID of Traffic Matching List containing ports to match.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_firewall_policy_port_reference_filter_dto = cls(
            type_=type_,
            match_opposite=match_opposite,
            traffic_matching_list_id=traffic_matching_list_id,
        )

        integration_firewall_policy_port_reference_filter_dto.additional_properties = d
        return integration_firewall_policy_port_reference_filter_dto
