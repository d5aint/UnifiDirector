...
T = TypeVar("T", bound="IntegrationFirewallScheduleEveryDayDto")


@_attrs_define
class IntegrationFirewallScheduleEveryDayDto:
    """
    Attributes:
        mode (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_firewall_schedule_every_day_dto = cls(
            mode=mode,
            time_filter=time_filter,
        )

        integration_firewall_schedule_every_day_dto.additional_properties = d
        return integration_firewall_schedule_every_day_dto
