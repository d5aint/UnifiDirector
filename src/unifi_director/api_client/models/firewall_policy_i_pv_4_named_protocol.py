...
T = TypeVar("T", bound="FirewallPolicyIPv4NamedProtocol")


@_attrs_define
class FirewallPolicyIPv4NamedProtocol:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        firewall_policy_i_pv_4_named_protocol = cls(
            name=name,
        )

        firewall_policy_i_pv_4_named_protocol.additional_properties = d
        return firewall_policy_i_pv_4_named_protocol
