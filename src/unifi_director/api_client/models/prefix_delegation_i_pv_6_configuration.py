...
T = TypeVar("T", bound="PrefixDelegationIPv6Configuration")


@_attrs_define
class PrefixDelegationIPv6Configuration:
    """
    Attributes:
        interface_type (str):
        client_address_assignment (IPv6ClientAddressAssignment):
        prefix_delegation_wan_interface_id (UUID): ID of the WAN interface from which the prefix is delegated.
    ...
    interface_type: str
    client_address_assignment: IPv6ClientAddressAssignment
    prefix_delegation_wan_interface_id: UUID
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        prefix_delegation_wan_interface_id = str(self.prefix_delegation_wan_interface_id)
        ...
        field_dict.update(
            {
                ...
                "prefixDelegationWanInterfaceId": prefix_delegation_wan_interface_id,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        prefix_delegation_wan_interface_id = UUID(d.pop("prefixDelegationWanInterfaceId"))
        ...
        prefix_delegation_i_pv_6_configuration = cls(
            interface_type=interface_type,
            client_address_assignment=client_address_assignment,
            prefix_delegation_wan_interface_id=prefix_delegation_wan_interface_id,
        ...
        prefix_delegation_i_pv_6_configuration.additional_properties = d
        return prefix_delegation_i_pv_6_configuration
