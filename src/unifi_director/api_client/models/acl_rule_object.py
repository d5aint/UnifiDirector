...
from ..models.acl_rule_object_action import ACLRuleObjectAction
...
T = TypeVar("T", bound="ACLRuleObject")
...
class ACLRuleObject:
    ...
    Attributes:
        ...
        action (ACLRuleObjectAction): ACL rule action Example: ALLOW|BLOCK.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        action = ACLRuleObjectAction(d.pop("action"))
        ...
        acl_rule_object.additional_properties = d
        return acl_rule_object
