...
from ..models.integration_ip_acl_rule_dto_protocol_filter_item import IntegrationIpAclRuleDtoProtocolFilterItem
...
T = TypeVar("T", bound="IntegrationIpAclRuleDto")


@_attrs_define
class IntegrationIpAclRuleDto:
    """
    Attributes:
        type_ (str):
        id (UUID):
        ...
        protocol_filter (list[IntegrationIpAclRuleDtoProtocolFilterItem] | Unset): Protocols this ACL rule will be
            applied to. When null, the rule will be applied to all protocols.
    """
    ...
    protocol_filter: list[IntegrationIpAclRuleDtoProtocolFilterItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _protocol_filter is not UNSET:
            ...
            for protocol_filter_item_data in _protocol_filter:
                protocol_filter_item = IntegrationIpAclRuleDtoProtocolFilterItem(protocol_filter_item_data)

                protocol_filter.append(protocol_filter_item)

        integration_ip_acl_rule_dto = cls(
            type_=type_,
            id=id,
            enabled=enabled,
            name=name,
        ...
        integration_ip_acl_rule_dto.additional_properties = d
        return integration_ip_acl_rule_dto
