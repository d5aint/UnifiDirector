...
T = TypeVar("T", bound="IntegrationFirewallPolicySourceIpAddressFilterDto")


@_attrs_define
class IntegrationFirewallPolicySourceIpAddressFilterDto:
    """
    Attributes:
        type_ (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_firewall_policy_source_ip_address_filter_dto = cls(
            type_=type_,
        ...
        integration_firewall_policy_source_ip_address_filter_dto.additional_properties = d
        return integration_firewall_policy_source_ip_address_filter_dto
