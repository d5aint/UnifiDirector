...
T = TypeVar("T", bound="IntegrationDnsMxRecordDto")


@_attrs_define
class IntegrationDnsMxRecordDto:
    """
    Attributes:
        type_ (str):
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_dns_mx_record_dto = cls(
            type_=type_,
            id=id,
            enabled=enabled,
            metadata=metadata,
        ...
        integration_dns_mx_record_dto.additional_properties = d
        return integration_dns_mx_record_dto
