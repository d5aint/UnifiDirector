...
T = TypeVar("T", bound="FirewallPolicyPortFilter")


@_attrs_define
class FirewallPolicyPortFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        firewall_policy_port_filter = cls(
            type_=type_,
            match_opposite=match_opposite,
        )

        firewall_policy_port_filter.additional_properties = d
        return firewall_policy_port_filter
