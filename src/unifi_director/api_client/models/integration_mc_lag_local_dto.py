...
T = TypeVar("T", bound="IntegrationMcLagLocalDto")


@_attrs_define
class IntegrationMcLagLocalDto:
    """
    Attributes:
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_mc_lag_local_dto = cls(
            id=id,
            members=members,
            metadata=metadata,
        )

        integration_mc_lag_local_dto.additional_properties = d
        return integration_mc_lag_local_dto
