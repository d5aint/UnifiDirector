...
T = TypeVar("T", bound="FirewallPolicyIPAddressFilter")


@_attrs_define
class FirewallPolicyIPAddressFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        firewall_policy_ip_address_filter = cls(
            type_=type_,
            match_opposite=match_opposite,
        )

        firewall_policy_ip_address_filter.additional_properties = d
        return firewall_policy_ip_address_filter
