...
from ...models.integration_lag_page_dto import IntegrationLagPageDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/sites/{site_id}/switching/lags".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> IntegrationLagPageDto | None:
    if response.status_code == 200:
        response_200 = IntegrationLagPageDto.from_dict(response.json())
...
) -> Response[IntegrationLagPageDto]:
    return Response(
