...
from ...models.integration_site_to_site_vpn_tunnel_overview_page_dto import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/sites/{site_id}/vpn/site-to-site-tunnels".format(
...
) -> IntegrationSiteToSiteVpnTunnelOverviewPageDto | None:
    if response.status_code == 200:
        response_200 = IntegrationSiteToSiteVpnTunnelOverviewPageDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[IntegrationSiteToSiteVpnTunnelOverviewPageDto]:
    return Response(
