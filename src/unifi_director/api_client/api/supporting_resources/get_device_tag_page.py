...
from ...models.integration_device_tag_page_dto import IntegrationDeviceTagPageDto
...
def _get_kwargs(
    ...
    *,
    offset: int | Unset = 0,
    limit: int | Unset = 25,
    filter_: FilterExpression | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/sites/{site_id}/device-tags".format(
...
) -> IntegrationDeviceTagPageDto | None:
    if response.status_code == 200:
        response_200 = IntegrationDeviceTagPageDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[IntegrationDeviceTagPageDto]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        filter_ (FilterExpression | Unset):
